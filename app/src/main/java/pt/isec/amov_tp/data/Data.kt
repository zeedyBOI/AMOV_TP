...
class Data(var productsList: ArrayList<Product>, var shopList: ArrayList<ShoppingList>, var categoryList: ArrayList<String>, var unitList: ArrayList<String>) : Serializable {
