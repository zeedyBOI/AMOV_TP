...
class Item(val category : Category, var designation : String, var brand : String = "Any", var quantity : String, var srcImage : String = "null", var priceHistory : List<Double>, var notes : String) {
